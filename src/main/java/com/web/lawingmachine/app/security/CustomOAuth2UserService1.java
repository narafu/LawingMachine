...
@Service
public class CustomOAuth2UserService1 extends DefaultOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public CustomOAuth2UserService1() {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        httpSession.setAttribute("user", new SessionUser(userInfoVo));
